...
object ApiClient {
    private const val BASE_URL = "http://3.129.43.1:8080/" // Reemplaza con la URL base de tu API
    ...
    private const val BASE_URL2 = "http://3.129.43.1:3000/" // Reemplaza con la URL base de tu API
    ...
    private const val BASE_URL3 = "http://3.129.43.1:8081/" // Reemplaza con la URL base de tu API
